...
export const VIZ_CATEGORIES = [
  ...
  { id: 'judge',         label: 'Judge Validation',   subtitle: 'RQ1 PRIMARY · 22.2% combined keyword-judge disagreement · α negative on R, M', color: '#00B4D8' },
...
export const VISUALIZATIONS = [
  ...
  },
  {
    ...
    subtitle: 'Gemini 0.7326 [0.7117, 0.7532] · Claude 0.6945 [0.6722, 0.7169]',
    caption: '10,000 bootstrap resamples per model, seed=42, percentile method. Under literature weights, Gemini #1 with a 3.8pp lead over #2 Claude.',
    source: 'experiments/results_v2/bootstrap_ci.json',
  ...
  // ── 2. JUDGE VALIDATION (RQ1 PRIMARY) ─────────────────────────
  {
    ...
    subtitle: 'Krippendorff α = 0.55 (assumption) · −0.099 (RQ) · −0.042 (M)',
    caption: 'Three of four shared dimensions show keyword/judge divergence. Reasoning_quality α is NEGATIVE with CI [−0.152, −0.045] excluding zero (n=1,095). Method_structure CI contains zero. Combined-scope α (n=3,195) reports assumption +0.605.',
  ...
  },
  {
    ...
    caption: 'Each point is a single run scored by both raters. Off-diagonal mass = the 25% base keyword-judge disagreement; combined denominator pushes to 22.2% across 3,195 runs.',
  ...
  },
  {
    ...
    caption: 'Combined per-model keyword-judge disagreement: claude 27.7% (177/639), gemini 23.5%, mistral 21.4%, chatgpt 19.1%, deepseek 19.1%. 9-point spread under the population mean.',
    source: 'experiments/results_v2/keyword_vs_judge_agreement.json',
