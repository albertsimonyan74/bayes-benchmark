...
- Du et al. (2025) [Ice Cream] — causal pitfalls / assumption violation
...
- Boye & Moell (2025)            — rubric design validation (Math-Reasoning-Failures)
...
> in causal-statistical reasoning (Du et al., 2025) and mathematical
> reasoning (Boye & Moell, 2025).
